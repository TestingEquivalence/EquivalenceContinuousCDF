...
dataSetLeukemia=c(7,    47,   58,  74, 177,  232,  273,  285,  317,  429,  440,  445,
...
# This data set contains waiting times of bank customers (in minutes) before service.
# The data set is originally from Ghitany ME, Atieh B & Nadarajah S, 2008, Lindley distribution
# and its application, Mathematics and computers in simulation, 78(4), pp. 493–506.
dataSetWaitingTimes=c(0.8, 0.8, 1.3, 1.5, 1.8, 1.9, 1.9, 2.1, 2.6, 2.7,
...
# Failure times for right rear breaks on D9G66A Caterpillar tractors.
# The data set is originally from  R. E. Barlow and R. Campo. 
# Total time on test processes and applications to failure data analysis. 
# In Reliability and Fault Tree Analysis, pages 451–481. SIAM, 1975.

dataSetRearBreaks=c(56,     83, 104, 116, 244, 305, 429, 452, 453, 503, 552, 614, 661, 673, 683, 685, 753, 763, 
                    806,   834, 838, 862, 897, 904, 981, 1007, 1008, 1049, 1060, 1107, 1125, 1141, 1153, 1154, 
                    1193, 1201, 1253, 1313, 1329, 1347, 1454, 1464, 1490, 1491, 1532, 1549, 1568, 1574, 
                    1586, 1599, 1608, 1723, 1769, 1795, 1927, 1957, 2005, 2010, 2016, 2022, 2037, 2065,
                    2096, 2139, 2150, 2156, 2160, 2190, 2210, 2220, 2248, 2285, 2325, 2337, 2351, 2437,
                    2454, 2546, 2565, 2584, 2624, 2675, 2701, 2755, 2877, 2879, 2922, 2986, 3092, 3160,
                    3185, 3191, 3439, 3617, 3685, 3756, 3826, 3995, 4007, 4159, 4300, 4487, 5074, 5579,
                    5623, 6869, 7739)
